...
const CreateListing = () => {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto bg-sage rounded-lg mt-5">
      <h1 className="text-2xl font-semibold text-center my-7 uppercase text-slate-500">Update Listing</h1>
          ...
          <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80 bg-white "
              >
